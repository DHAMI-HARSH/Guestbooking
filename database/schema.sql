...
CREATE TABLE Bookings (
  ...
  room_configuration NVARCHAR(50) NULL CHECK (room_configuration IN ('Double Bed', 'Triple Bed', 'Twin Sharing') OR room_configuration IS NULL),
  meal_plan VARCHAR(20) NOT NULL DEFAULT 'General' CHECK (meal_plan IN ('General', 'Special')),
  extra_bed BIT NOT NULL DEFAULT 0,
  guests NVARCHAR(MAX) NULL,
  food_reservations NVARCHAR(MAX) NULL,
  ...
  room_selection NVARCHAR(MAX) NULL,
